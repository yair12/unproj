...
public class Game : LoadBalancingClient
{
	...
	private int numberOfHitsCounter=0;
    ...
    public void Update()
    {
		...
		//Debug.Log(this.pos.ToString()+",frust"+frust.ToString()+",STE"+st.ToString()+",LTE"+lt.ToString()+ System.DateTime.Now.ToString());
    ...
    public override void OnEvent(EventData eventData)
    {
		...
		switch (eventData.Code)
        {
            ...
            case EventCode.Leave:
                {
					...
					Debug.Log("Leave;" +System.DateTime.Now.ToString()+";frust"+frust.ToString()+";STE"+st.ToString()+"LTE"+lt.ToString());
            ...
            case Constants.EV_HIT:
				...
				numberOfHitsCounter++;
				Debug.Log ("EMO;PlayerDamaged;" + numberOfHitsCounter + ";" + System.DateTime.Now.ToString ());
                }
                break;
            ...
            case Constants.EV_CHAT:
                {
					...
					float st = EmotiveController.Controller.ShortTermExcitement; 
					float lt = EmotiveController.Controller.LongTermExcitement ;
					Debug.Log ("EMO;IncomingMessageCHAT;c" + ";" + System.DateTime.Now.ToString ());
